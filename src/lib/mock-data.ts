...
export const mockTrendData = [
  { date: '02/23', '租車': 28, '計程車': 38, '共享機車': 12 },
  { date: '03/01', '租車': 32, '計程車': 45, '共享機車': 15 },
  { date: '03/08', '租車': 40, '計程車': 52, '共享機車': 18 },
  { date: '03/15', '租車': 35, '計程車': 48, '共享機車': 22 },
  { date: '03/22', '租車': 55, '計程車': 61, '共享機車': 25 },
  { date: '03/29', '租車': 48, '計程車': 58, '共享機車': 28 },
  { date: '04/05', '租車': 62, '計程車': 72, '共享機車': 32 },
  { date: '04/12', '租車': 58, '計程車': 68, '共享機車': 35 },
]
